...
//Create a sprite for Invisible ground and place it at the bottom side of the screen.
  kangaroo = createsprite(200, 400, 100, 100);
  kangarooR = addAnimation(kangaroo_running);
  kangarooC = addAnimation(kangaroo_collided);
  kangaroo.setCollider("circle", 300)
  invisibleGround = createSprite(200, 0, 100, 800);
